// Karel teklif HTML — tek sayfa Fiyatlandırma + Karel İş Ortağı rozeti
import { fmtPara, fmtTarih, escapeHtml, toplamHesapla, sayfaFooterHtml, ortakStil } from './ortak'

export const karelHtml = ({ teklif, gorseller }) => {
  ...
  return `<!DOCTYPE html><html><head><meta charset="utf-8"/>
    ...
    <div class="teklif-sayfa">
      ...
      <div class="karel-rozet"><img src="${gorseller.karelOrtak}" /></div>
