...
export const ALT_KATEGORILER = {
  ariza: [
    { id: 'qr_arizasi', isim: 'QR arızası' },
    { id: 'telefon_arizasi', isim: 'Telefon arızası' },
    { id: 'bariyer_arizasi', isim: 'Bariyer arızası' },
    { id: 'buton_arizasi', isim: 'Buton arızası' },
    { id: 'cctv_off', isim: 'CCTV OFF' },
    { id: 'kamera_arizasi', isim: 'Kamera arızası' },
    { id: 'panel_arizasi', isim: 'Panel arızası' },
  ...
  kesif: [
    { id: 'santral_kesifi', isim: 'Santral keşifi' },
    { id: 'pts_kesifi', isim: 'PTS keşifi' },
  ...
  bakim: [
    { id: 'cctv_bakim', isim: 'CCTV bakım' },
    { id: 'pdks_bakim', isim: 'PDKS bakım' },
    { id: 'hirsiz_alarm_bakim', isim: 'Hırsız alarm bakım' },
    { id: 'tanitim_ekranlari_bakim', isim: 'Tanıtım ekranları bakım' },
    { id: 'plaka_tanima_bakim', isim: 'Plaka tanıma sistemi bakım' },
    ...
    { id: 'pdks_bakimi', isim: 'PDKS bakımı (eski)' },
  ...
  kurulum: [
    { id: 'cctv_kurulum', isim: 'CCTV kurulum' },
    { id: 'pdks_kurulum', isim: 'PDKS kurulum' },
    { id: 'hirsiz_alarm_kurulum', isim: 'Hırsız alarm kurulum' },
    { id: 'santral_kurulum', isim: 'Santral kurulum' },
    { id: 'ekran_kurulum', isim: 'Ekran kurulum' },
    { id: 'alarm_kurulum', isim: 'Alarm kurulum' },
